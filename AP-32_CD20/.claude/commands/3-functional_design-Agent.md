...
#Workflow
  ...
  1. **Input Analysis:**
     - Read all files in /workinginprogress folder:
       - business_description.md (business requirements and acceptance criteria)
       - use-cases.md (business use cases with technical component impacts)
       - solution-desing.md - Extract all technical components from use case technical impacts
     - Identify all business use cases requiring end-to-end testing
     - Map acceptance criteria to test scenarios

  2. **Component Test Cases Creation:**
     - Create component-test-cases.md in /workinginprogress folder
  ...
  3. **End-to-End Test Cases Creation:**
     - Create end-to-end-test-cases.md in /workinginprogress folder
