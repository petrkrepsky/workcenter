...
#Workflow
  1. **Input Analysis:**
     ...
     - Read aůů files in folder /workinprogress
  ...
  4. **Documentation:**
     - Create comprehensive concept summary in workinprogress folder named business_idea.md
  ...
  5. **Deliverables:**
     - Concept summary ready for analysis phase - business_idea.md
